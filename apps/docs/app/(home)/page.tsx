...
const quickLinks = [
  ...
  },
  {
    ...
    description: 'Queue execution, heartbeat, browser runtime, and scaling notes.',
    href: '/docs/worker',
  },
  {
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-fd-foreground md:text-6xl">
              Queue-first scraping platform docs for API, workers, and operations.
            </h1>
          ...
          <div className="grid gap-3 text-sm text-fd-muted-foreground md:grid-cols-3">
            <div className="rounded-2xl border border-fd-border bg-fd-card/70 p-4">
              ...
              <p className="mt-1">API only accepts and tracks jobs. Workers do the heavy work.</p>
            </div>
            <div className="rounded-2xl border border-fd-border bg-fd-card/70 p-4">
              <p className="font-medium text-fd-foreground">Worker Fleet</p>
              <p className="mt-1">Scale Docker and VM workers together on the same queue.</p>
            </div>
            <div className="rounded-2xl border border-fd-border bg-fd-card/70 p-4">
              <p className="font-medium text-fd-foreground">Ops Ready</p>
              <p className="mt-1">Heartbeat, queue depth, retry, DLQ, and health endpoints included.</p>
            </div>
          </div>
        </div>

        <div className="rounded-3xl border border-fd-border bg-gradient-to-br from-fd-card via-fd-card to-fd-secondary/70 p-6 shadow-sm">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-fd-foreground">System Overview</p>
